...
class GaussianModel:
    ...
    def create_from_verts(self, points, features_dc):
        ...
        # dist2 = torch.clamp_min(knn_points(points[None,...], points[None,...], K=1).dists.squeeze(), 0.0000001)
        ...
        opacities = torch.ones((points.shape[0], 1), dtype=torch.float, device="cuda")
